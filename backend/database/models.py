...
class PerfilSalvo(Base):
    ...
    __table_args__ = (
        UniqueConstraint("cliente_usuario", "instagram_pk", name="uq_perfil_cliente_instagram_pk"),
    )
...
class Monitoramento(Base):
    ...
    __table_args__ = (
        UniqueConstraint("cliente_usuario", "instagram_pk", name="uq_monitoramento_cliente_instagram_pk"),
    )
